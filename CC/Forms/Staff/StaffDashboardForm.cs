...
{
    /// <summary>
    /// Staff Dashboard module form matching the Sweet Story CRM design mockup.
    /// Renders dynamic summary cards, task status pills, and interactive navigation to modules.
    /// </summary>
    public class StaffDashboardForm : CC.Forms.Shared.DashboardShell
    {
        ...
        private async void ShowDashboard()
        {
            ...
            {
                Text = "Dashboard",
                Font = new Font(UITheme.FontSerif, 22F, FontStyle.Bold), // text-2xl
            ...
            {
                Text = $"My Tasks \u00B7 {DateTime.Now:MMM d, yyyy}",
                Font = new Font(UITheme.FontSans, 9.5F, FontStyle.Regular), // subtitle text-sm
            ...
            leftCard.Click += (s, e) => { SidebarCtrl?.SetActiveItem("Follow-ups"); OnNavigationRequested("Follow-ups"); };
