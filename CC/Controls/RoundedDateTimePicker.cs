...
{
    /// <summary>
    /// A Panel wrapper for DateTimePicker with rounded background painting matching RoundedTextBox.
    /// </summary>
    public class RoundedDateTimePicker : Panel
    {
        private readonly DateTimePicker _inner;
        public int CornerRadius { get; set; } = 18;

        public DateTimePicker InnerDateTimePicker => _inner;
